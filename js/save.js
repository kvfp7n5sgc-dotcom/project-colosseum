...
function createNewState(){
  return {
    saveVersion:"0.7.1",level:1,xp:0,xpNext:100,gold:120,energy:10,maxEnergy:10,lastEnergyTick:Date.now(),
...
function migrateState(raw){
  ...
  state.selectedRegion=state.selectedRegion||"outskirts";state.profileType=state.profileType||"player";state.worldUnlocked=Boolean(state.worldUnlocked);state.saveVersion="0.7.1";return state;
}
